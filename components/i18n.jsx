...
window.TRANSLATIONS = {
  fr: {
    ...
    myroom: {
      ...
      view_courtyard: 'Cour',
      note_groundfloor: 'Accès plain-pied',
      note_groundfloor_court: 'Accès plain-pied — depuis la cour',
      note_dormitory: 'Dortoir — 8 couchages partagés',
      note_annex: 'Annexe — corps ancien, à 2 min de la cour',
      note_family_room: 'Chambre familiale — lits adaptés',
      directions: {
        '210': "Entrée principale, escalier central, 1ᵉʳ étage.",
        '203': "Aile Sud, 1ᵉʳ étage. Au milieu du couloir.",
        '328': "Escalier central jusqu'au 2ᵉ étage. Dortoir au bout, côté Est.",
        '510': "Sortir de la cour côté Nord-Est, suivre le passage 2 min.",
        '130': "Aile Nord, accès direct depuis la cour. Plain-pied.",
      },
    },
  },
  ...
  ge: {
    ...
    myroom: {
      ...
      view_courtyard: 'ეზო',
      note_groundfloor: 'პირველი სართული — საფეხურების გარეშე',
      note_groundfloor_court: 'საფეხურების გარეშე — პირდაპირ ეზოდან',
      note_dormitory: 'საერთო საძილე — 8 საწოლი',
      note_annex: 'დანართი — ძველი კორპუსი, ეზოდან 2 წუთის სავალზე',
      note_family_room: 'საოჯახო ოთახი — ადაპტირებული საწოლები',
      directions: {
        '210': 'მთავარი შესასვლელი, ცენტრალური კიბე, I სართული.',
        '203': 'სამხრეთის ფრთა, I სართული. დერეფნის შუაში.',
        '328': 'ცენტრალური კიბით II სართულამდე. დერეფნის ბოლოს, აღმოსავლეთით.',
        '510': 'ეზოდან გადით ჩრდილო-აღმოსავლეთით, გაჰყევით გასასვლელს 2 წუთი.',
        '130': 'ჩრდილოეთის ფრთა, პირდაპირი შესასვლელი ეზოდან. საფეხურების გარეშე.',
      },
    },
  },
  ...
  de: {
    ...
    myroom: {
      ...
      view_courtyard: 'Hof',
      note_groundfloor: 'Ebenerdiger Zugang',
      note_groundfloor_court: 'Ebenerdiger Zugang — direkt vom Hof',
      note_dormitory: 'Schlafsaal — 8 geteilte Schlafplätze',
      note_annex: 'Nebengebäude — Altbau, 2 Min. vom Hof',
      note_family_room: 'Familienzimmer — angepasste Betten',
      directions: {
        '210': 'Haupteingang, zentrale Treppe, 1. Etage.',
        '203': 'Südflügel, 1. Etage. Mitte des Flurs.',
        '328': 'Zentrale Treppe bis zur 2. Etage. Schlafsaal am Ende, Ostseite.',
        '510': 'Vom Hof aus nach Nordosten, dem Durchgang 2 Min. folgen.',
        '130': 'Nordflügel, direkter Zugang vom Hof. Ebenerdig.',
      },
    },
  },
};
