...
window.TRANSLATIONS = {
  fr: {
    ...
    dress: {
      ...
      lbl_men: 'Messieurs',
      req_men: ['Costume', 'sombre'],
      lbl_women: 'Mesdames',
      req_women: ['Robe', 'longue'],
  ...
  ge: {
    ...
    reception: {
      ...
      intro: ['მზის ჩასვლისას, ფანჯრები სათითაოდ ნათდება.', 'დღესასწაული შეიძლება დაიწყოს.'],
      lbl_address: 'მისამართი',
    ...
    timeline: {
      ...
      events: [
        ...
        { time: '20:00', title: 'ვახშამი',      sub: 'ქართული სუფრა — კახური ღვინო', icon: '◇' },
    ...
    dress: {
      ...
      lbl_men: 'ბატონებო',
      req_men: ['მუქი', 'კოსტიუმი'],
      lbl_women: 'ქალბატონებო',
      req_women: ['გრძელი', 'კაბა'],
  ...
  de: {
    ...
    reception: {
      ...
      intro: ['In der Abenddämmerung leuchten die Fenster eins nach dem anderen auf.', 'Das Fest kann beginnen.'],
      lbl_address: 'Adresse',
    ...
    timeline: {
      ...
      events: [
        ...
        { time: '20:00', title: 'Abendessen',        sub: 'Georgisches Buffet — Supra & Wein aus Kachetien', icon: '◇' },
    ...
    dress: {
      ...
      lbl_men: 'Herren',
      req_men: ['Dunkler', 'Anzug'],
      lbl_women: 'Damen',
      req_women: ['Langes', 'Kleid'],
